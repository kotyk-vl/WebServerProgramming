...
namespace SageBook.Lab2.MVC
{
    public class Program
    {
        public static void Main(string[] args)
        {
            ...
            var connectionString = builder.Configuration.GetConnectionString("SageBookContext") ?? throw new InvalidOperationException("Connection string 'SageBookContext' not found.");
